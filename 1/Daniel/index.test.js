// not sure if I should commit my setup for running those tests

import { solveDay1Part1, solveDay1Part2 } from './index.js'
...
])('.solveDay1Part1()', ({ input, expected }) => {
  expect(solveDay1Part1(input)).toStrictEqual(expected)
})
...
])('.solveDay1Part2()', ({ input, expected }) => {
  expect(solveDay1Part2(input)).toStrictEqual(expected)
})
