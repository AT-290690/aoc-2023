import { solveDay2Part1, solveDay2Part2 } from './index.js'
...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green`,
  ...
  {
    input: `Game 1: 4 red, 5 blue, 4 green; 7 red, 8 blue, 2 green; 9 blue, 6 red; 1 green, 3 red, 7 blue; 3 green, 7 red
...
])('.solveDay2Part1()', ({ input, expected }) => {
  expect(solveDay2Part1(input)).toStrictEqual(expected)
})
...
])('.solveDay2Part2()', ({ input, expected }) => {
  expect(solveDay2Part2(input)).toStrictEqual(expected)
})
